  ...
  const renderProductBadges = useCallback((product) => {
    ...
    if (product.isFeatured) {
      badges.push(
        <span
          key="featured"
          className="inline-flex items-center gap-1 px-2 py-0.5 text-xs font-medium rounded bg-yellow-100 text-yellow-800"
        >
          <Star size={12} />
          Featured
        </span>,
    ...
    if (product.isPremium) {
      badges.push(
        <span
          key="premium"
          className="inline-flex items-center gap-1 px-2 py-0.5 text-xs font-medium rounded bg-purple-100 text-purple-800"
        >
          <Crown size={12} />
          Premium
        </span>,
    ...
    if (product.isBest) {
      badges.push(
        <span
          key="best"
          className="inline-flex items-center gap-1 px-2 py-0.5 text-xs font-medium rounded bg-red-100 text-red-800"
        >
          <Award size={12} />
          Best Seller
        </span>,
              ...
              <div className="mt-4 pt-4 border-t border-gray-200">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-4">
                  ...
                  <select
                    ...
                    onChange={(e) =>
                      handleFilterChange("isOnSale", e.target.value)
                    }
                    className="px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
                  >
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                  ...
                  <select
                    ...
                    onChange={(e) =>
                      handleFilterChange("isBest", e.target.value)
                    }
                    className="px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
                  >
                    ...
                    <tbody className="divide-y divide-gray-200">
                      {products.map((product) => (
                        ...
                        >
                          ...
                          <td className="px-6 py-4">
                            <span
                              className={`text-sm font-medium ${product.quantity <= (product.lowStockThreshold || 10) ? "text-red-600" : "text-green-600"}`}
                            >
                              {product.quantity || 0}
                            </span>
                            {product.quantity <=
                          ...
                          <td className="px-6 py-4">
                            <div className="space-y-1">
                              <span
                                className={`inline-block px-2 py-1 text-xs font-medium rounded ${getStatusBadge(product.status)}`}
                              >
                                {product.status}
                              </span>
              ...
              <div className="p-6 space-y-4">
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <div className="space-y-1">
                      <span
                        className={`inline-block px-2 py-1 text-xs font-medium rounded ${getStatusBadge(selectedProduct.status)}`}
                      >
                  ...
                  <div>
                    ...
                    <p className="font-medium">
                      {selectedProduct.isFreeShipping ? "Yes" : "No"}
                    </p>
                  </div>
                </div>
